...
enum class StrId : uint16_t {
  ...
  STR_LIBRARY,
  STR_TRANSLATE_BOOK,
  STR_SELECT_TRANSLATE_LANG,
  STR_TRANSLATING_BOOK,
  STR_TRANSLATION_DONE,
  STR_TRANSLATION_FAILED,
  STR_TRANSLATION_CANCELLED,
  STR_TRANSLATE_TO,
  STR_BACK_TO_CANCEL,
  STR_TRANSLATE_CHAPTER,
  STR_RETRANSLATE_CHAPTER,
  STR_TRANSLATING_CHAPTER,
  STR_CHAPTER_ALREADY_TRANSLATED,
  STR_RETRANSLATE_CONFIRM,
  STR_TRANSLATION_ENGINE,
  STR_TRANSLATE_API_KEY,
  STR_ENGINE_GOOGLE_FREE,
  STR_ENGINE_DEEPL,
  STR_ENGINE_DEEPL_PRO,
  STR_ENGINE_OPENAI,
  STR_ENGINE_DEEPSEEK,
  STR_ENGINE_GEMINI,
  STR_ENGINE_GOOGLE_V2,
  STR_ENGINE_GOOGLE_HTML,
  STR_SOURCE_LANGUAGE,
  STR_AUTO_DETECT,
  STR_TRANSLATION_GREY,
  ...
  STR_TOOLTIP_NAV,
  STR_LOOP,
  STR_RETRANSLATE_BOOK,
  STR_SKIP_TRANSLATED,
  STR_RETRANSLATE_ALL,
  STR_CHAPTERS_ALREADY_TRANSLATED,
  STR_BOOK_TRANSLATION_DONE,
  STR_BOOK_TRANSLATION_CANCELLED,
