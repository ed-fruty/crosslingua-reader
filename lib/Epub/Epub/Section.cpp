...
//      anchored at the x of the sentence's first WORD. v41 also feeds the sentence pairing the
//      focus-MERGED word stream rather than the raw token array, so Focus Reading no longer moves a
//      sentence boundary. The header layout and every per-page/per-line structure are BYTE-IDENTICAL to v40 --
