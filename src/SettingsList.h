...
inline std::vector<SettingInfo> getSettingsList() {
  return {
      ...
      // --- Reader ---
      SettingInfo::Enum(StrId::STR_TRANSLATION_ENGINE, &CrossPointSettings::translationEngine,
                        {StrId::STR_ENGINE_GOOGLE_FREE, StrId::STR_ENGINE_DEEPL, StrId::STR_ENGINE_DEEPL_PRO,
                         ...
                         StrId::STR_ENGINE_GOOGLE_V2, StrId::STR_ENGINE_GOOGLE_HTML},  // order matches enum values
                        "translationEngine", StrId::STR_CAT_READER),
      ...
      SettingInfo::Value(StrId::STR_LINE_SPACING, &CrossPointSettings::lineSpacing, {5, 30, 1}, "lineSpacing",
                         StrId::STR_CAT_READER),
