...
//
// PT_INTERLINEAR is LAST deliberately: it was added once its layout landed (PtLayout::Interlinear),
...
inline constexpr CrossPointSettings::PRE_TRANSLATION_MODE PT_SELECTABLE_MODES[] = {
    ...
    CrossPointSettings::PT_PAGE_TRANSLATION, CrossPointSettings::PT_INTERLINEAR,
};
