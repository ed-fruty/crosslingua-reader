...
int CrossPointSettings::getReaderFontId() const {
  switch (fontFamily) {
    ...
    case CAECILIA:
      switch (fontSize) {
        case SMALL:
          return CAECILIA_12_FONT_ID;
        case MEDIUM:
        default:
          return CAECILIA_14_FONT_ID;
        case LARGE:
          return CAECILIA_16_FONT_ID;
        case EXTRA_LARGE:
          return CAECILIA_18_FONT_ID;
      }
    case GPRO:
      switch (fontSize) {
        case SMALL:
          return GPRO_12_FONT_ID;
        case MEDIUM:
        default:
          return GPRO_14_FONT_ID;
        case LARGE:
          return GPRO_16_FONT_ID;
        case EXTRA_LARGE:
          return GPRO_18_FONT_ID;
      }
  }
}
